    ...
    up: function (queryInterface, Sequelize) {
        ...
        */
        return queryInterface.sequelize.transaction(function (t) {
            return Promise.all([
                queryInterface.addColumn("Grades", "legislatorId", {
                ...
                queryInterface.addColumn("Grades", "userId", {
                    type: Sequelize.INTEGER,
                    references: {
                        model: "Users",
                        key: "id"
                ...
                queryInterface.addColumn("Updates", "legislatorId", {
                    type: Sequelize.INTEGER,
                    references: {
                        model: "Legislators",
                        key: "id"
                ...
                queryInterface.addColumn("Updates", "userId", {
                    type: Sequelize.INTEGER,
                    references: {
                        model: "Users",
                        key: "id"
                ...
                queryInterface.addColumn("Legislators", "userId", {
                    type: Sequelize.INTEGER,
                    references: {
                        model: "Users",
                        key: "id"
