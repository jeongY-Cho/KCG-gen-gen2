...
const template = require(join(process.cwd(), "/utils/template"));
...
function main() {
  let data: IReportCardData = {
    imgLink:
      "http://leg.colorado.gov/sites/default/files/styles/width_300/public/2019a_arndt%2C%20jeni.jpg?itok=x-tF-KT0",
    title: "SENATOR",
    district: 1,
    session: 72,
  ...
  setTimeout(() => {
    generator.makeReportCard(data).then(buffer => {
